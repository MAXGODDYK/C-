...
// ДЗ6 (Тема 6). Повний цикл керування списком студентів:
// Add (з полів форми) / Edit (модальний StudentEditForm) / Delete,
// валідація у формі та в діалозі, плюс Варіант Б — пошук за ПІБ
// (TextBox, що фільтрує ListBox у реальному часі).
...
namespace Portfolio {
    ...
    private:
        ...
        void InitializeComponent() {
            ...
            this->Text = L"StudentPortfolio - Theme 6 (HW6: Add/Edit/Delete + search)";
        ...
        // ДЗ6 #2: Edit — модальний StudentEditForm, зміни лише за DialogResult::OK.
