...
namespace Portfolio {
    ...
    private:
        ...
        void InitializeComponent() {
            ...
            // Індивідуальне оформлення (Палієнко В.М.): синій акцент.
            ...
            this->Text = L"StudentPortfolio - Theme 11 - Palienko Volodymyr M.";
            this->ClientSize = System::Drawing::Size(644, 330);
            this->BackColor = Color::FromArgb(230, 240, 255);   // індивідуальний фон (синій відтінок)
