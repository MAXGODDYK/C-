// Тема 4 (об'єднання СР4 + ДЗ4). Індивідуальний проєкт — Палієнко Володимир Максимович.
// Демонстраційний приклад: серед об'єктів створюється студент Палієнко В.М.
...
int main() {
    ...
    cout << "=== Theme 4 - Palienko Volodymyr M. (combined: SR4 + HW4) ===" << endl << endl;

    vector<Person*> people;

    // Індивідуальний студент проєкту — Палієнко Володимир Максимович.
    // (Прізвище / Ім'я / По-батькові передаються як lastName / firstName / midName.)
    auto* palienko = new Student("Володимир", "Максимович", "Палієнко", "Male", 19,
                                 "PI-21", "College of IT", "cat", "football");
    palienko->setAverageGrade(5.0);
    palienko->addHobby("programming");
    people.push_back(palienko);
