...
namespace Portfolio {
    ...
    private:
        ...
        void InitializeComponent() {
            ...
            // Індивідуальне оформлення (Захльобін): помаранчевий акцент.
            btnExportExcel->FlatStyle = FlatStyle::Flat;
            btnExportExcel->BackColor = Color::DarkOrange;
            ...
            this->Text = L"StudentPortfolio - Theme 11 - Zakhliobin";
            this->ClientSize = System::Drawing::Size(644, 330);
            this->BackColor = Color::FromArgb(255, 243, 224);   // індивідуальний фон (помаранчевий відтінок)
